<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustMgrTemplate.aspx.cs"
    Inherits="CustMgrTemplate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>客戶管理系統樣板</title>
    ...
    <div>                 
            <table border="2" cellpadding="2" cellspacing="2" width="720">
                ...
                <td colspan=3>
                    <span><strong>
                    <asp:Label
                ID="lab_Title" Text="客戶管理系統樣板" runat="server"></asp:Label> </strong>
                    </span>
                </td>
                <tr>
                    <td bgcolor="khaki">
