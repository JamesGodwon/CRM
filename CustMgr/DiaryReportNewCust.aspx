<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DiaryReportNewCust.aspx.cs"
    Inherits="DiaryReportNewCust" %>
    ...
    <form id="form1" runat="server">                    
            <table border="2" cellpadding="2" cellspacing="2" width="720">
                ...
                <td colspan=3>
                    <span><strong>
                    <asp:Label
                ID="lab_Title" Text="統計查詢→新戶拜訪日誌統計" runat="server"></asp:Label> </strong>
                    </span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;
...
ORDER BY
	...
	<asp:Label ID="lab_State" runat="server" style="color: #0000FF"></asp:Label>
        ...
        <asp:LinkButton ID="LinkBtn_BrnoDetail" runat="server" 
                onclick="LinkBtn_BrnoDetail_Click">依AO統計</asp:LinkButton> &nbsp;
    ...
    &nbsp;&nbsp;<asp:LinkButton ID="LinkBtn_QueryResultDisplay" runat="server" 
            ...
            <asp:LinkButton ID="LinkBtn_ByParner" runat="server" 
                onclick="LinkBtn_ByParner_Click" Visible="False" 
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TOTALEDITEMPNO" HeaderText="登錄員人數" 
                        SortExpression="TOTALEDITEMPNO" Visible="False" />
                    <asp:BoundField DataField="TOTALCUSTSUM" HeaderText="拜訪戶數" ReadOnly="True" 
                        SortExpression="TOTALCUSTSUM" />
                    <asp:BoundField DataField="TOTALPHONE" HeaderText="電訪次數" ReadOnly="True" 
                        SortExpression="TOTALPHONE" Visible="False" />
                    ...
                    <asp:BoundField DataField="TOTALCUST" HeaderText="總次數" ReadOnly="True" 
                        SortExpression="TOTALCUST" Visible="False" />
                </Columns>
    ...
    <asp:Label ID="lab_BrnoTitle" runat="server" 
        style="font-weight: 700; color: #0000FF" Text="依AO統計"></asp:Label>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TOTALCUSTSUM" HeaderText="拜訪戶數" 
                        SortExpression="TOTALCUSTSUM" />
                    <asp:BoundField DataField="TOTALPHONE" HeaderText="電訪次數" ReadOnly="True" 
                        SortExpression="TOTALPHONE" Visible="False" />
                    <asp:BoundField DataField="TOTALPERSON" HeaderText="親訪次數" ReadOnly="True" 
    ...
    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="VISITTYPE" HeaderText="電訪/親訪" 
                SortExpression="VISITTYPE" Visible="False" />
        </Columns>
        <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
        <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" 
            Wrap="False" />
...
ORDER BY
  ...
  , BRNO')" onselecting="dsCustLisMain_Selecting">
	...
	<asp:HiddenField ID="hidn_BRNO" runat="server" />
	 ...
	 , isnull(h.COLDESC, i.COLDESC) AS ENTSIZE
	 , isnull(j.COLDESC, k.COLDESC) AS CUSTTYPE
	 , isnull(m.GROUPNO, n.GROUPNO) as GROUPNO
	 , isnull(m.GROUPNAME, n.GROUPNAME) as GROUPNAME
