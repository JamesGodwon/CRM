<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupModify.aspx.cs"
    Inherits="GroupModify" %>
...
<body>
    ...
    <div>                 
            <table border="2" cellpadding="2" cellspacing="2" width="720">
                ...
                <td colspan=3>
                    <span><strong>
                    <asp:Label
                ID="lab_Title" Text="集團資料編輯" runat="server"></asp:Label> </strong>
    ...
    &nbsp;</td>
        ...
        <span  >
            ...
            <tr>
            <td colspan=2>
    <asp:Label ID="Label8" runat="server" Text="集團資料編輯" 
    ...
    <asp:Label ID="Label3" runat="server" Text="集團代號"></asp:Label>
            ...
            <td>
                <asp:Label ID="lab_GroupNO" runat="server"></asp:Label>
            </td>
    ...
    <asp:Label ID="Label9" runat="server" Text="集團核心企業統編"></asp:Label>
            ...
            <td>
                ...
                <asp:Label ID="lab_EntSerNoMain" runat="server"></asp:Label>
    ...
    <asp:Label ID="Label11" runat="server" Text="GAO"></asp:Label>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="dsGao" runat="server" 
                    ...
                    SelectCommand="SELECT b.NAME, b.STAFF FROM iom.dbo.CUSTMGR_GROUP AS a INNER JOIN EMPLOYEE AS b ON a.GAOEMPID = b.STAFF WHERE (a.ENTSERNOMAIN = @ENTSERNOMAIN) UNION SELECT NAME, STAFF FROM EMPLOYEE WHERE (BRNO = @brno) AND (STATUS = 1) AND (JOBCODE IN (SELECT JOBCODE FROM JOBCODE WHERE (JOBNAME LIKE '%帳戶管理員%'))) ORDER BY b.STAFF">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txt_MgrBrno" Name="brno" 
                            PropertyName="Text" />
        ...
        <tr>
            <td>
                <asp:Button ID="btn_Add" runat="server" onclick="btn_Add_Click" Text="修改" />
    ...
    <asp:SqlDataSource ID="dsGroup" runat="server" 
        ...
        SelectCommand="SELECT a.GROUPNO, a.GROUPNAME, a.ENTSERNOMAIN, a.CRCNO, a.ENTNAMEMAIN, a.MGRBRNO, a.GAOEMPID, a.BUILDDATE, a.MODIFYDATE, b.NAME FROM CUSTMGR_GROUP AS a LEFT OUTER JOIN chb_pub.dbo.EMPLOYEE AS b ON a.GAOEMPID = b.STAFF WHERE (a.ENTSERNOMAIN = @ENTSERNOMAIN) ORDER BY a.BUILDDATE DESC" 
        ...
        <InsertParameters>
            <asp:ControlParameter ControlID="lab_GroupNO" Name="GROUPNO" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="hidn_ENTSERNOMAIN" Name="ENTSERNOMAIN" 
                PropertyName="Value" />
        </SelectParameters>
        <UpdateParameters>
            <asp:ControlParameter ControlID="txt_GroupName" Name="GROUPNAME" 
            ...
            <asp:ControlParameter ControlID="txt_EntNameMain" Name="ENTNAMEMAIN" 
                PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txt_MgrBrno" Name="MGRBRNO" 
                PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="drList_Gao" Name="GAOEMPID" 
                PropertyName="SelectedValue" Type="String" />
            <asp:ControlParameter ControlID="hidn_ENTSERNOMAIN" Name="ENTSERNOMAIN" 
    ...
    <asp:HiddenField ID="hidn_ENTSERNOMAIN" runat="server" />
