<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpQuery.aspx.cs"
    Inherits="ImpQuery" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div>                 
            <table border="2" cellpadding="2" cellspacing="2" width="720">
                ...
                <td colspan=3>
                    <span><strong>
                    <asp:Label
                ID="lab_Title" Text="TCRI重大訊息查詢" runat="server"></asp:Label> </strong>
                    </span>
                </td>          
            </table>            
            <br />
			...
			<tr>
				<td>
					<asp:Label ID="Label5" runat="server" Text="請輸入查詢條件" 
			...
			<tr>
				<td>
				    ...
				    <asp:Label ID="Label16" runat="server" Text="統一編號"></asp:Label>
                </td>
				<td>
					<asp:TextBox ID="txt_SernoChange" runat="server" Width="151px"></asp:TextBox>
                </td>
			</tr>
            <tr>
				<td>
					
				    <asp:Label ID="Label6" runat="server" Text="評等日期"></asp:Label>
                </td>
				<td>
					<asp:TextBox ID="txt_PerDayStart" runat="server" Width="151px"></asp:TextBox>
				    <asp:Label ID="Label7" runat="server" Text="~"></asp:Label>
					<asp:TextBox ID="txt_PerDayEnd" runat="server" Width="151px"></asp:TextBox>
				    <asp:Label ID="Label17" runat="server" Text="西元年(YYYYMMDD) 例如：20110101"></asp:Label>
                </td>
			</tr>
			<tr>
				<td colspan="2">
	...
	where 1=1 '+@condition+' order by  [公司] ,評等日期 desc  ')">
                <SelectParameters>
			...
			<tr>
				<td>
					<asp:Label ID="Label18" runat="server" Text="請輸入查詢條件" 
                        Style="font-weight: 700; color: #0000FF;"></asp:Label>
				</td>
				<td>
			...
			<tr>
				<td>
				    ...
				    <asp:Label ID="Label19" runat="server" Text="統一編號"></asp:Label>
                </td>
				<td>
					<asp:TextBox ID="txt_SernoChange1" runat="server" Width="151px"></asp:TextBox>
                </td>
			</tr>
            <tr>
				<td>
					
				    <asp:Label ID="Label20" runat="server" Text="事件日期"></asp:Label>
                </td>
				<td>
					<asp:TextBox ID="txt_CheckDayStart" runat="server" Width="151px"></asp:TextBox>
				    <asp:Label ID="Label21" runat="server" Text="~"></asp:Label>
					<asp:TextBox ID="txt_CheckDayEnd" runat="server" Width="151px"></asp:TextBox>
				    <asp:Label ID="Label22" runat="server" Text="西元年(YYYYMMDD) 例如：20110101"></asp:Label>
                </td>
			</tr>
			<tr>
				<td colspan="2">
					<asp:Button ID="btn_Query0" runat="server" Text="查詢" 
                        onclick="btn_Query0_Click" />
					<asp:Label ID="lab_State0" runat="server" Style="color: #0000FF"></asp:Label>
				</td>
			</tr>
		</table>
            <br />
...
">
            ...
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                ...
                AllowPaging="True" Width="925px" EmptyDataText="查無危機公司大事紀資料" 
			...
			<tr>
				<td>
					<asp:Label ID="Label23" runat="server" Text="請輸入查詢條件" 
                        Style="font-weight: 700; color: #0000FF;"></asp:Label>
				</td>
				<td>
			...
			<tr>
				<td>
				    ...
				    <asp:Label ID="Label24" runat="server" Text="統一編號"></asp:Label>
                </td>
				<td>
					<asp:TextBox ID="txt_SernoChange2" runat="server" Width="151px"></asp:TextBox>
                </td>
			</tr>
            <tr>
				<td>
					
				    <asp:Label ID="Label25" runat="server" Text="現任擔任年月"></asp:Label>
                </td>
				<td>
					<asp:TextBox ID="txt_MonthStart" runat="server" Width="151px"></asp:TextBox>
				    <asp:Label ID="Label26" runat="server" Text="~"></asp:Label>
					<asp:TextBox ID="txt_MonthEnd" runat="server" Width="151px"></asp:TextBox>
				    <asp:Label ID="Label27" runat="server" Text="西元年(YYYYMM) 例如：201101"></asp:Label>
                </td>
			</tr>
			<tr>
				<td colspan="2">
					<asp:Button ID="btn_Query1" runat="server" Text="查詢" 
                        onclick="btn_Query1_Click" />
					<asp:Label ID="lab_State1" runat="server" Style="color: #0000FF"></asp:Label>
				</td>
			</tr>
		</table>
...
<ItemStyle Width="10%"></ItemStyle>
                    ...
                    <asp:TemplateField HeaderText="現任董事長" SortExpression="現任董事長">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("現任董事長") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("現任董事長") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="11%" />
                    </asp:TemplateField>
...
<ItemStyle Width="11%"></ItemStyle>
                    ...
                    <asp:TemplateField HeaderText="現任財務長" SortExpression="現任財務長">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("現任財務長") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
