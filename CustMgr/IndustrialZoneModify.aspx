<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndustrialZoneModify.aspx.cs"
    Inherits="IndustrialZoneModify" %>
...
<body>
    ...
    <div>                 
            <table border="2" cellpadding="2" cellspacing="2" width="720">
                ...
                <td colspan=3>
                    <span><strong>
                    <asp:Label
                ID="lab_Title" runat="server">工業區資料編輯</asp:Label> </strong>
    ...
    <asp:Label ID="Label3" runat="server" Text="工業區名稱"></asp:Label>
            ...
            <td>
                <asp:Label ID="lab_ZoneName" runat="server"></asp:Label>
    ...
    <asp:Label ID="Label5" runat="server" Text="區域"></asp:Label>
            ...
            <td>
                ...
                <asp:DropDownList ID="drList_Region" runat="server" DataSourceID="dsRegion" 
                    DataTextField="COLDESC" DataValueField="COLVALUE" AutoPostBack="True" 
                    onselectedindexchanged="drList_Region_SelectedIndexChanged">
                </asp:DropDownList>
                <asp:SqlDataSource ID="dsRegion" runat="server" 
                    ...
                    SelectCommand="SELECT '' AS COLVALUE, '請選擇' AS COLDESC UNION SELECT COLVALUE, COLDESC FROM CUSTMGR_OPTION WHERE (DBCOLUMN = 'REGION')">
                </asp:SqlDataSource>
    ...
    <asp:Label ID="Label4" runat="server" Text="所在縣市區"></asp:Label>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="dsCity" runat="server" 
                    ...
                    SelectCommand="SELECT '請選擇' AS CITYNAME, '' AS CITYNO UNION SELECT DISTINCT CITYNAME, CITYNO FROM CUSTMGR_CITY ORDER BY CITYNO">
                </asp:SqlDataSource>
                ...
                <asp:SqlDataSource ID="dsSection" runat="server" 
                    ...
                    SelectCommand="SELECT '請選擇' AS SECTIONNAME, '' AS SECTIONNO UNION SELECT SECTIONNAME, SECTIONNO FROM CUSTMGR_CITY WHERE (CITYNAME = @CITYNAME) ORDER BY SECTIONNO">
                    <SelectParameters>
    ...
    <asp:Button ID="btn_Add" runat="server" Text="修改" onclick="btn_Add_Click" 
        style="width: 40px" />
    ...
    <asp:SqlDataSource ID="dsMgrIndustrialZone" runat="server" 
        ...
        InsertCommand="INSERT INTO CUSTMGR_INDUSTRIALZONE(ZONENAME, LOCATION, MGRNAME, MGRTEL, MGRADDRESS, BRNO, EDITEMPID) VALUES (@ZONENAME, @LOCATION, @MGRNAME, @MGRTEL, @MGRADDRESS, @BRNO, @EDITEMPID)" 
        SelectCommand="SELECT a.ZONENAME, a.LOCATION, a.MGRNAME, a.MGRTEL, a.MGRADDRESS, a.BRNO + '_' + c.BRNAME AS BRNO, a.BUILDDATE, a.MODIFYDATE, a.BRNO AS BRNOORG, d.COLDESC AS REGIONDESC, a.REGION FROM CUSTMGR_INDUSTRIALZONE AS a LEFT OUTER JOIN chb_pub.dbo.crc_rel_br AS b ON a.BRNO = b.BRNO LEFT OUTER JOIN chb_pub.dbo.BRANCH AS c ON a.BRNO = c.BRNO LEFT OUTER JOIN CUSTMGR_OPTION AS d ON a.REGION = d.COLVALUE AND d.DBCOLUMN = 'REGION' WHERE (a.ZONENAME = @ZONENAME) ORDER BY b.CRCNO, BRNO" 
        ...
        UpdateCommand="UPDATE CUSTMGR_INDUSTRIALZONE SET LOCATION = @LOCATION, REGION = @REGION, MGRNAME = @MGRNAME, MGRTEL = @MGRTEL, MGRADDRESS = @MGRADDRESS, BRNO = @BRNO, MODIFYDATE = CONVERT ([char] (8), GETDATE(), 112), EDITEMPID = @EDITEMPID WHERE (ZONENAME = @ZONENAME)">
        <DeleteParameters>
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="hidn_ZONENAME" Name="ZONENAME" 
                PropertyName="Value" />
        </SelectParameters>
        <UpdateParameters>
            <asp:ControlParameter ControlID="txt_Location" Name="LOCATION" 
                PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txt_MgrName" Name="MGRNAME" 
                PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txt_MgrTel" Name="MGRTEL" PropertyName="Text" 
            ...
            <asp:ControlParameter ControlID="txt_MgrAddress" Name="MGRADDRESS" 
                PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txt_MgrBrno" Name="BRNO" PropertyName="Text" 
                Type="String" />
            <asp:ControlParameter ControlID="hidn_ZONENAME" Name="ZONENAME" 
                PropertyName="Value" Type="String" />
            <asp:ControlParameter ControlID="hidn_EmpNo" Name="EDITEMPID" 
                PropertyName="Value" />
            <asp:ControlParameter ControlID="txt_Region" Name="REGION" 
                PropertyName="Text" />
        </UpdateParameters>
    </asp:SqlDataSource>
    <asp:HiddenField ID="hidn_ZONENAME" runat="server" />
    </form>
</body>
</html>
