<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsMgr.aspx.cs"
    Inherits="NewsMgr" %>
...
<body>
    ...
    <div>                 
            <table border="2" cellpadding="2" cellspacing="2" width="720">
                ...
                <td colspan=3>
                    <span><strong>
                    <asp:Label
                ID="lab_Title" Text="最新訊息維護" runat="server"></asp:Label> </strong>
                    </span>
                </td>
                <tr>
                    <td bgcolor="khaki">
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" 
        NavigateUrl="~/Program/CustMgr/bb.aspx">HyperLink</asp:HyperLink>
    </form>
</body>
</html>
