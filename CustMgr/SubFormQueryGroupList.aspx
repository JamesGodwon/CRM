<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubFormQueryGroupList.aspx.cs"
    Inherits="SubFormQueryGroupList" %>
...
<body onload="GetPriviousUrl()">
    ...
    <div>                 
            <table border="2" cellpadding="2" cellspacing="2" width="720">
                ...
                <td colspan=3>
                    <span><strong>
                    <asp:Label
                ID="lab_Title" Text="搜尋集團資料" runat="server"></asp:Label> </strong>
                    </span>
                </td>
                <tr>
                    <td bgcolor="khaki">
    ...
    <asp:Label ID="Label3" runat="server" Text="請輸入集團代號或名稱"></asp:Label>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        ...
        BorderStyle="None" BorderWidth="1px" 
                            CellPadding="3" CellSpacing="2" DataKeyNames="GROUPNO" 
    ...
    <asp:SqlDataSource ID="dsEntSernoMainData" runat="server" 
        ...
        SelectCommand="SELECT GROUPNO, GROUPNAME FROM CUSTMGR_GROUP WHERE (GROUPNO LIKE '%' + @GROUPDATA + '%') OR (GROUPNAME LIKE '%' + @GROUPDATA + '%')">
        <SelectParameters>
            <asp:ControlParameter ControlID="txt_QueryID" Name="GROUPDATA" 
                                    PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
