<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubFormQueryMainEntList.aspx.cs"
    Inherits="SubFormQueryMainEntList" %>
...
<body onload="GetPriviousUrl()">
    ...
    <asp:Label ID="Label3" runat="server" Text="請輸入母公司統編或名稱"></asp:Label>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        ...
        BorderStyle="None" BorderWidth="1px" 
                            ...
                            DataSourceID="dsEntSernoMainData" EmptyDataText="無集團資料" 
                            EnableModelValidation="True" 
        onselectedindexchanging="GridView2_SelectedIndexChanging" 
        AllowPaging="True" PageSize="5">
        <Columns>
            <asp:CommandField ShowSelectButton="True" />
            <asp:BoundField DataField="ENTSERNOMAIN" HeaderText="母公司統編" ReadOnly="True" 
                                    SortExpression="ENTSERNOMAIN" />
            <asp:BoundField DataField="ENTNAMEMAIN" HeaderText="母公司名稱" 
    ...
    <asp:SqlDataSource ID="dsEntSernoMainData" runat="server" 
        ...
        SelectCommand="SELECT ENTSERNOMAIN, ENTNAMEMAIN FROM CUSTMGR_GROUP WHERE (ENTSERNOMAIN LIKE '%' + @ENTSERNOMAIN + '%') OR (ENTNAMEMAIN LIKE '%' + @ENTSERNOMAIN + '%') UNION SELECT SERNO AS ENTSERNOMAIN, ACCOUNTNAME AS ENTNAMEMAIN FROM CUSTMGR_CUSTLIST WHERE (SERNO LIKE '%' + @ENTSERNOMAIN + '%') OR (ACCOUNTNAME LIKE '%' + @ENTSERNOMAIN + '%')">
        <SelectParameters>
